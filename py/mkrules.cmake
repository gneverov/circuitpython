...
separate_arguments(MICROPY_CPP_FLAGS NATIVE_COMMAND ${CMAKE_C_FLAGS})
SET(
    MICROPY_CPP_FLAGS 
    ${MICROPY_CPP_FLAGS}
    -I$<JOIN:$<TARGET_PROPERTY:${MICROPY_TARGET},INCLUDE_DIRECTORIES>,;-I>
    -D$<JOIN:$<TARGET_PROPERTY:${MICROPY_TARGET},COMPILE_DEFINITIONS>,;-D>
