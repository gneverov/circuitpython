...
set(LIBC_OBJECTS
    ...
    # libc_iconv_ccs_big5.c.o
    # libc_iconv_ccs_ccsbi.c.o
    # libc_iconv_ccs_cns11643_plane14.c.o
    # libc_iconv_ccs_cns11643_plane1.c.o
    # libc_iconv_ccs_cns11643_plane2.c.o
    # libc_iconv_ccs_cp775.c.o
    # libc_iconv_ccs_cp850.c.o
    # libc_iconv_ccs_cp852.c.o
    # libc_iconv_ccs_cp855.c.o
    # libc_iconv_ccs_cp866.c.o
    # libc_iconv_ccs_iso_8859_10.c.o
    # libc_iconv_ccs_iso_8859_11.c.o
    # libc_iconv_ccs_iso_8859_13.c.o
    # libc_iconv_ccs_iso_8859_14.c.o
    # libc_iconv_ccs_iso_8859_15.c.o
    # libc_iconv_ccs_iso_8859_1.c.o
    # libc_iconv_ccs_iso_8859_2.c.o
    # libc_iconv_ccs_iso_8859_3.c.o
    # libc_iconv_ccs_iso_8859_4.c.o
    # libc_iconv_ccs_iso_8859_5.c.o
    # libc_iconv_ccs_iso_8859_6.c.o
    # libc_iconv_ccs_iso_8859_7.c.o
    # libc_iconv_ccs_iso_8859_8.c.o
    # libc_iconv_ccs_iso_8859_9.c.o
    # libc_iconv_ccs_iso_ir_111.c.o
    # libc_iconv_ccs_jis_x0201_1976.c.o
    # libc_iconv_ccs_jis_x0208_1990.c.o
    # libc_iconv_ccs_jis_x0212_1990.c.o
    # libc_iconv_ccs_koi8_r.c.o
    # libc_iconv_ccs_koi8_ru.c.o
    # libc_iconv_ccs_koi8_u.c.o
    # libc_iconv_ccs_koi8_uni.c.o
    # libc_iconv_ccs_ksx1001.c.o
    # libc_iconv_ccs_win_1250.c.o
    # libc_iconv_ccs_win_1251.c.o
    # libc_iconv_ccs_win_1252.c.o
    # libc_iconv_ccs_win_1253.c.o
    # libc_iconv_ccs_win_1254.c.o
    # libc_iconv_ccs_win_1255.c.o
    # libc_iconv_ccs_win_1256.c.o
    # libc_iconv_ccs_win_1257.c.o
    # libc_iconv_ccs_win_1258.c.o
    # libc_iconv_ces_cesbi.c.o
    # libc_iconv_ces_euc.c.o
    # libc_iconv_ces_table.c.o
    # libc_iconv_ces_table-pcs.c.o
    # libc_iconv_ces_ucs-2.c.o
    # libc_iconv_ces_ucs-2-internal.c.o
    # libc_iconv_ces_ucs-4.c.o
    # libc_iconv_ces_ucs-4-internal.c.o
    # libc_iconv_ces_us-ascii.c.o
    # libc_iconv_ces_utf-16.c.o
    # libc_iconv_ces_utf-8.c.o
    # libc_iconv_lib_aliasesbi.c.o
    # libc_iconv_lib_aliasesi.c.o
    libc_iconv_lib_iconv.c.o
    # libc_iconv_lib_iconvnls.c.o
    # libc_iconv_lib_nullconv.c.o
    # libc_iconv_lib_ucsconv.c.o
    # libc_locale_duplocale.c.o
    # libc_locale_freelocale.c.o
    # libc_locale_lctype.c.o
    # libc_locale_lmessages.c.o
    # libc_locale_lmonetary.c.o
    # libc_locale_lnumeric.c.o
    # libc_locale_locale.c.o
    # libc_locale_localeconv.c.o
    # libc_locale_newlocale.c.o
    # libc_locale_nl_langinfo.c.o
    # libc_locale_timelocal.c.o
    # libc_locale_uselocale.c.o
    # libc_misc___dprintf.c.o
    # libc_misc_ffs.c.o
    # libc_misc_fini.c.o
    # libc_misc_init.c.o
    # libc_misc_lock.c.o
    ...
    # libc_stdlib_wcstod.c.o
    # libc_stdlib_wcstoimax.c.o
    # libc_stdlib_wcstol.c.o
    # libc_stdlib_wcstoll.c.o
    # libc_stdlib_wcstombs.c.o
    # libc_stdlib_wcstoul.c.o
    # libc_stdlib_wcstoull.c.o
    # libc_stdlib_wcstoumax.c.o
    ...
    # libm_common_isinfl.c.o
    # libm_common_isnanl.c.o
    ...
    # libm_common_sf_isinff.c.o
    # libm_common_sf_isnan.c.o
    # libm_common_sf_isnanf.c.o
    ...
    # libm_common_s_isinfd.c.o
    # libm_common_s_isnan.c.o
    # libm_common_s_isnand.c.o
